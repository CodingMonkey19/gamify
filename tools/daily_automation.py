...
PIPELINE_STEPS = [
    ...
    ("streak_decay",            ".streak_engine",       "apply_decay",                 False),
    ("fitness_xp",              ".fitness_engine",      "aggregate_xp",                False),
    ("nutrition_xp",            ".nutrition_engine",    "aggregate_xp",                False),
    ("financial_xp",            ".financial_engine",    "aggregate_xp",                False),
